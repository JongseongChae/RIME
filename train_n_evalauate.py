...
def learn_the_2_sampled_envs(args):
    ...
    elif (("rime" in args.algo_name.lower()) and ("md" not in args.algo_name.lower())) or "omme" in args.algo_name.lower():
    ...
    for j in range(num_updates):
        ...
        for step in range(args.num_steps):
            ...
            elif ("rime" in args.algo_name.lower()) and ("md" not in args.algo_name.lower()):
        ...
        if len(episode_rewards1) > 1 and len(episode_rewards2) > 1:
            ep_learning_curve1.append(np.mean(episode_rewards1))
            ep_learning_curve2.append(np.mean(episode_rewards2))
            total_num_steps = (j + 1) * args.num_processes * args.num_steps
            ep_timesteps.append(total_num_steps)
    ...
    return [perfs, [ep_timesteps, ep_learning_curve1, ep_learning_curve2], excute_name]
...
def learn_the_3_sampled_envs(args):
    ...
    for j in range(num_updates):
        ...
        if len(episode_rewards1) > 1 and len(episode_rewards2) > 1 and len(episode_rewards3) > 1:
            ep_learning_curve1.append(np.mean(episode_rewards1))
            ep_learning_curve2.append(np.mean(episode_rewards2))
            ep_learning_curve3.append(np.mean(episode_rewards3))
            total_num_steps = (j + 1) * args.num_processes * args.num_steps
            ep_timesteps.append(total_num_steps)
    ...
    return [perfs, [ep_timesteps, ep_learning_curve1, ep_learning_curve2, ep_learning_curve3], excute_name]
...
def learn_the_4_sampled_envs(args):
    ...
    for j in range(num_updates):
        ...
        if len(episode_rewards1) > 1 and len(episode_rewards2) > 1  and len(episode_rewards3) > 1 and len(episode_rewards4) > 1:
            ...
            ep_learning_curve2.append(np.mean(episode_rewards2))
            ep_learning_curve3.append(np.mean(episode_rewards3))
            ep_learning_curve4.append(np.mean(episode_rewards4))
            total_num_steps = (j + 1) * args.num_processes * args.num_steps
            ep_timesteps.append(total_num_steps)
            end = time.time()
    ...
    return [perfs_2par_gm, [ep_timesteps, ep_learning_curve1, ep_learning_curve2, ep_learning_curve3, ep_learning_curve4], excute_name]
